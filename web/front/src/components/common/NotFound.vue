<template>
  <div class="not-found parallax">
    ...
    <a class="wave-island" href="/">
      <img :src="islandImage" alt="Island" @click="backToHome" />
    </a>
    ...
    <div class="wave-boat">
      <img class="boat" :src="boatImage" alt="Boat" />
    </div>
...
<script setup>
import { ref } from "vue";
import islandImage from "@/assets/island.svg";
...
.not-found {
  ...
  height: 100vh;
  [class*="wave"] {
    filter: hue-rotate(340deg) brightness(1) saturate(1.8);
    position: absolute;
  }
  ...
  div {
    ...
    @for $i from 1 through 7 {
      &.wave-#{$i} {
        background: url(@/assets/wave-#{$i}.svg);
      }
    }
    &.sky-bg {
      background: url(@/assets/sky-bg.svg);
      height: 100%;
    }
